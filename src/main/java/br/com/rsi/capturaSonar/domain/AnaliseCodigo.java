...
public class AnaliseCodigo implements Serializable {
	...
	public String toString() {
		return "AnaliseCodigo [id=" + id + ", url=" + url + ", painelGestor=" + painelGestor + ", sigla=" + sigla
				+ ", dataCommit=" + dataCommit + ", dataSonar=" + dataSonar + ", versao=" + versao + ", dataCaptura="
				+ dataCaptura + ", nomeProjeto=" + nomeProjeto + ", linhaCodigo=" + linhaCodigo + ", linhaCodigoAnt="
				+ linhaCodigoAnt + ", bugs=" + bugs + ", codeSmall=" + codeSmall + ", vulnerabilidades="
				...
				+ descricao + ", debitoTecnico=" + debitoTecnico + ", debitoTecnicoMinutos=" + debitoTecnicoMinutos
				+ ", esforcoConfiabilidade=" + esforcoConfiabilidade + ", esforcoSeguranca=" + esforcoSeguranca
				+ ", cobertura=" + cobertura + ", notaProjeto=" + notaProjeto + ", notaAnterior=" + notaAnterior
				+ ", qualidade=" + qualidade + ", coeficiente=" + coeficiente + ", devops=" + devops
				+ ", codigoAlterado=" + codigoAlterado + "]";
	}
